...
numbers_to_strings = { -5: "negative five",
                -4 : "negative four",
                -3 : "negative three",
                -2 : "negative two",
                -1 : "negative one",
...
def simple_calculator(first, operator, second):
    a =  string_to_numbers.get(first)
    b =  string_to_numbers.get(second)
    if a == None or b == None or operator not in ['plus', 'minus']:
    ...
    print(" ".join([first, operator, second, 'equals', numbers_to_strings[result]]))
