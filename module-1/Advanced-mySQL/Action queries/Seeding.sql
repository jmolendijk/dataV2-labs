...
;
#Seeding data into table customers
...
#Seeding data into salespersons table
...
;
#Seeding data into table Invoices
INSERT INTO Invoices(invoice_number, date, car, customer_id, salepersons_id)
VALUES
