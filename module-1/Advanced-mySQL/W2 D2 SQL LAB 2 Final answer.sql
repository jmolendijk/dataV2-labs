...
# Create table with 2 columns: au_id - Author ID  & profits - The profits of the author aggregating the advances and royalties

CREATE TABLE publications.most_profiting_authors_nelly
SELECT 
authors.au_id,  
SUM(titles.advance * titleauthor.royaltyper / 100) + SUM(titles.price * sales.qty * titles.royalty / 100 * titleauthor.royaltyper / 100)  as total_profit
