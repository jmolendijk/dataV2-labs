...
select profit.au_id, (profit.advance_total + profit.royalty_total) as profit
from
	(select calc.au_id, calc.title_id, sum(advance) as advance_total, sum(sales_royalty) as royalty_total
	from
		(select titles.title_id, 
...
select profit.au_id as au_id, (profit.advance_total + profit.royalty_total) as profits
from profit
