...
Insert into store
values
(30001, 'Madrid', 'Spain',CURRENT_TIMESTAMP),
(30002,  'Barcelona','Spain',CURRENT_TIMESTAMP),
(30004, 'Berlin','Germany',CURRENT_TIMESTAMP),
(30005, 'Paris','France',CURRENT_TIMESTAMP);
...
update sales
set
(40001, 20180810, 30001, 00001,1,852399038,1,CURRENT_TIMESTAMP),
(40002, 20181231,30004,00003,2, 731166526,1,CURRENT_TIMESTAMP),
(40003, 20190121,30005,00004,5, 731166526,1, CURRENT_TIMESTAMP);
